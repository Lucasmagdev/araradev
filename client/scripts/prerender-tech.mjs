...
for (const page of pages) {
  ...
  const markup = `<div class="lp-page"><main class="blog-post-page"><div class="lp-container blog-post-grid">
    <article class="blog-post-article">
      ...
      ${page.partner ? `<div class="blog-post-cta"><p>${esc(page.partner.description)}</p><a href="${esc(page.partner.url)}" target="_blank" rel="noopener nofollow sponsored" class="lp-btn-primary lp-btn-lg">Conhecer ${esc(page.partner.name)}</a></div>` : ''}
